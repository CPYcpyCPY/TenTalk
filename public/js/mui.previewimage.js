(function($, window) {
	...
	var template = '<div id="{{id}}" class="mui-slider mui-preview-image mui-fullscreen"><div class="mui-preview-header">{{header}}</div><div class="mui-slider-group"></div><div class="mui-preview-footer ">{{footer}}</div><div class="mui-preview-loading"><span class="mui-spinner mui-spinner-white"></span></div></div>';
	...
	var PreviewImage = function(options) {
		this.options = $.extend(true, {
			...
			footer: '<span class="mui-preview-footerContent"></span>'
		}, options || {});
		this.init();
		this.initEvent();
	};
